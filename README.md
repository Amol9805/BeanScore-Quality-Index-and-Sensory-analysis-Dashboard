...
## 🔷 Project Overview
This project focuses on analyzing Arabica coffee quality data from the Coffee Quality Institute (CQI) to uncover insights related to sensory attributes, processing methods, regional differences, defects, varieties, and altitude influence.
...
Time Info → Harvest Year, Grading Date
...
Sensory attributes(10), Total Cup Points, category One defects, category two defects, Number of Bags, Weight of Bag in Kg,

Toatl Defects, Altitude, Harvest Year

### Dimension Tables:
Dim Region → Country, Region , Avg Altitude (Created hierarchy from country --> Region)

Dim Processing Method → Processing Method

Dim Variety → Variety

Dim Date → Harvest Year, Grading Date
...
TopRegionName = 
  MAXX(SUMMARIZE('df_arabica_clean', 'df_arabica_clean'[Region], "RegionAvg", [Avg Cup Score]),
        IF([RegionAvg] = [TopRegionScore], 'df_arabica_clean'[Region]))


## Dashboard Pages & Visualizations
### 🟣 1. Sensory Attribute Analysis
This page focuses on identifying sensory drivers of cup quality.
...
Uniformity, Clean Cup, Sweetness are consistently maxed

### 🟠 2. Processing Method Analysis
This page compares methods and their impact on quality.
...
#### Insights:
Anaerobic methods yield experimental high scores but risk defects

Washed/Wet is stable but not always top‑scoring

### 🟢 3. Regional Differences
This page highlights geography and altitude influence.
...
Combo Chart → Region vs Avg Cup Score + AvgAltitude

KPI Card → Top scoring region

#### Insights:
Ethiopia, Tanzania, Guatemala consistently lead

Altitude positively correlates with cup score

### 🟡 4. Defects vs Quality
This page analyzes how defects reduce scores.
...
#### Insights:
Category One defects are most damaging

Semi‑Lavado and Pulped Natural methods most vulnerable
